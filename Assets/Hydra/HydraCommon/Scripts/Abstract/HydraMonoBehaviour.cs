...
namespace Hydra.HydraCommon.Abstract
{
	...
	public abstract class HydraMonoBehaviour : MonoBehaviour, IRecyclable
	{
		...
		public event EventHandler<EventArg<Collision>> onCollisionEnterCallback;
		...
		{
			EventHandler<EventArg<Collision>> handler = onCollisionEnterCallback;
			if (handler != null)
				handler(this, new EventArg<Collision>(collision));
		}
